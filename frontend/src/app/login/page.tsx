...
import { Shield, Loader2, ArrowRight, Lock, ArrowLeft } from "lucide-react";
        ...
        <main className="min-h-screen bg-[var(--background)] relative overflow-x-hidden font-sans flex flex-col transition-colors duration-500">
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-6 flex-1 flex flex-col justify-center py-8 lg:py-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="space-y-12 text-center lg:text-left order-1 lg:self-start">
                    ...
                    {/* Feature Grid Component - Order 3 on mobile, stacks under text on desktop */}
                    <div className="order-3 lg:col-start-1 lg:self-start">
                        <FeatureGrid />
                    </div>
                </div>
            </div>
